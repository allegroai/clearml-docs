...
[models](artifacts.md#models). Users can decide how to group tasks, but different models or objectives are usually grouped into different projects.
...
In the WebApp, every project has an editable markdown project overview, where a description of the project can be written and shared
(see [Project Overview](../webapp/webapp_project_overview.md)).

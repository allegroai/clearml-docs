...
* `OutputModel` - Use this class for a model that is the result of your ClearML experiment. An OutputModel is always connected to a [task](../fundamentals/task.md)

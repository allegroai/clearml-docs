...
The example below demonstrates the integration of ClearM into code which uses Keras and TensorBoard.
...
ClearM automatically logs command line options generated with `argparse`, and TensorFlow Definitions.

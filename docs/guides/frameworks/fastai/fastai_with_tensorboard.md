...
:::note FastAI V2
The ClearML repository FastAI examples also include [examples using FastAI v2](https://github.com/allegroai/clearml/tree/master/examples/frameworks/fastai).
:::

...
demonstrates ClearM's Plotly integration and reporting. 

Report Plotly plots in ClearM by calling the [`Logger.report_plotly`](../../references/sdk/logger.md#report_plotly) method, and passing a complex
...
ClearM reports Plotly plots in the **ClearML Web UI** **>** experiment details **>** **RESULTS** tab **>** **PLOTS** 
sub-tab.
